...
- **`useChildBuilders` default changed to `true`**: Child builder methods are now generated by default for properties that have their own builders. To disable, set `useChildBuilders: false`.
